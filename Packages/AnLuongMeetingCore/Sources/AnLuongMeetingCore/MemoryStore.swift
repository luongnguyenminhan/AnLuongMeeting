...
public enum GlossaryCategory: String, Codable, Sendable {
    case project
    case jargon
}

public struct GlossaryEntry: Identifiable, Codable, Sendable, Equatable {
    public let id: String
    public var term: String
    public var category: GlossaryCategory
...
public struct StylePreference: Identifiable, Codable, Sendable, Equatable {
    public let id: String
...
public struct MemoryData: Codable, Sendable, Equatable {
    public var glossary: [GlossaryEntry]
    public var participants: [Participant]
    public var stylePreferences: [StylePreference]
    public var ignoredTerms: Set<String>
    public var pendingMerges: [IdentityMergeSuggestion]
...
public struct MemoryStore: Sendable {
    ...
    public func save(_ memory: MemoryData) throws {
...
public struct NoteCorrection: Identifiable, Codable, Sendable, Equatable {
    public let id: String
...
public struct IdentityMergeSuggestion: Identifiable, Codable, Sendable, Equatable {
    public let id: String
...
public struct MemoryDraft: Sendable, Equatable {
    public var glossary: [GlossaryEntry]
    public var participants: [Participant]
    public var stylePreferences: [StylePreference]
    public var corrections: [NoteCorrection]
    public var identityMerges: [IdentityMergeSuggestion]
