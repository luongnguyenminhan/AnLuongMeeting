...
public struct RecallAnswer: Sendable {
    ...
    public init(text: String, citedMeetingIDs: [String]) {
        self.text = text
...
public struct RecallTurn: Sendable {
    public let question: String
    public let answerText: String

    public init(question: String, answerText: String) {
        self.question = question
        self.answerText = answerText
    }
}

public struct RecallAgent: Sendable {
    private let service: GeminiTranscriptionService

    public init(service: GeminiTranscriptionService) {
