...
enum GeminiTranscriptionError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .exportUnavailable:
            return "Celesnity Meeting could not create an audio segment exporter."
...
actor GeminiTranscriptionService {
    ...
    func transcribe(
        ...
        let temporaryDirectory = FileManager.default.temporaryDirectory
            .appendingPathComponent("CelesnityMeeting-Transcription-\(UUID().uuidString)", isDirectory: true)
